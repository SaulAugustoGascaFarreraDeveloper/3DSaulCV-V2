            ...
            <div className="md:grid md:grid-cols-2 md:gap-4">
                ...
                <div className='relative flex justify-center flex-col'>
                    ...
                    <div className='pl-[10px] pt-[10px] text-center'>
                        <a href=""><Image className='inline w-[40px] h-[40px] md:w-[60px] md:h-[60px]' src={instagramIcon} alt="Instagram Icon" /></a>
                        <a href=""><Image className='inline ml-[10px] w-[40px] h-[40px] md:w-[60px] md:h-[60px]' src={linkedinIcon} alt="linkedin Icon" /></a>
                        <a href=""><Image className='inline ml-[10px] w-[40px] h-[40px] md:w-[60px] md:h-[60px]' src={facebookIcon} alt="facebook Icon" /></a>
                        <a href=""><Image className='inline ml-[10px] w-[40px] h-[40px] md:w-[60px] md:h-[60px]' src={twitterIcon} alt="twitter Icon" /></a>
                        <a href=""><Image className='inline ml-[10px] w-[40px] h-[40px] md:w-[60px] md:h-[60px]' src={youtubeIcon} alt="youtube Icon" /></a>
                    </div>
                </div>
            </div>
